...
function_definition
	: type_specifier { currentfunctype = $1;parameters = true;} fun_declarator { loffset = 0;parameters = false;}
		{
		...
		{	
			...
			($$) = new funcdef_node(currentfuncid,currentfunctype,$6);
			($$)->generate_code();
...
statement
        ...
        | IDENTIFIER '(' {callfuncid.push($1);} expression_list {callfuncid.pop();}')' ';'
         	{
    ...
    : '-'
    	{
        	...
        	//($$) = new unary_op_node("Negative"); //yaha change kiya hai
       	}

	| '!'
		{
        	$$ = new identifier_node("Not");
        	//($$) = new unary_op_node("Not"); //yaha change kiya hai
       	} 	
	;
...
declarator_list
	: 
	 declarator 
	{
	abstract_node * t1  =  new declrlist_node($1);
	localattributes * t2  = $1;
	...
	abstract_node * t1  =  new declrlist_node($1,$3);
	abstract_node * t2  =  $1;
	localattributes * t3  =  $3;
